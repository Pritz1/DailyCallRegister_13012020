...
import com.eis.dailycallregister.Activity.PatientDrList;
...
public class PsrListUnderMgr extends Fragment {
        ...
        call1.enqueue(new Callback<MgrRCPARes>() {
            ...
            public void onResponse(retrofit2.Call<MgrRCPARes> call1, Response<MgrRCPARes> response) {
                ...
                if (response != null) {
                    ...
                    Snackbar.make(view, "Data Is Not Received From Database", Snackbar.LENGTH_LONG).show();
